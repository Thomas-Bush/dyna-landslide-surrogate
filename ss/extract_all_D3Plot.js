...
class D3PlotDataExtractor {
    ...
    extractNodes() {
        let csvContent = "Node_Index,Node_Label,Node_X,Node_Y,Node_Z\n";
    ...
    extractSolids() {
        let csvContent = "Soild_Index,Solid_Label,Solid_Part,Solid_N1,Solid_N2,Solid_N3,Solid_N4,Solid_N5,Solid_N6,Solid_N7,Solid_N8\n"; // CSV header
    ...
    extractShells() {
        let csvContent = "Shell_Index,Shell_Label,Shell_Part,Shell_N1,Shell_N2,Shell_N3,Shell_N4\n"; // CSV header for shells
    ...
    extractStates() {
        let csvContent = "State_Index,State_Timestamp\n"; // CSV header for states
